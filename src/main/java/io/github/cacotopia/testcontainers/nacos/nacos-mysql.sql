...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='config_tags_relation';
...
-- ----------------------------
INSERT INTO `config_info` VALUES ('1', 'nacos.core.version', 'DEFAULT_GROUP', '2.2.3', '61e0148c53f84669c0f42d35154be843', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, 'nacos', '', NULL, NULL, NULL, 'text', NULL);
